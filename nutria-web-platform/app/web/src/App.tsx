    ...
    return (
      <div className="api-offline-banner api-offline-banner--prod" role="status">
        ...
        <p className="api-offline-banner__body">
          Situs ini (misalnya di GitHub Pages) hanya file statis: tidak ada server login di balik domain
          yang sama. Masuk &amp; data butuh <strong>API Nutria</strong> jalan (lokal atau hosting). Untuk
          pakai penuh, clone repositori dan ikuti README — jalankan <code className="api-offline-banner__code">npm run dev</code>{' '}
          dari folder <code className="api-offline-banner__code">nutria-web-platform</code> di komputer sendiri.
        </p>
      </div>
    );
  }
